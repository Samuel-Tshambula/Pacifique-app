    ...
    <div className="plan-salle">
      ...
      {commandesPrêtes.length > 0 && (
        <div className="plats-prets-banner">
          <span className="prets-icon">🔔</span>
            ...
            {!commandeModal ? (
              ...
              <>
                <div className="modal-body">
                  ...
                  {commandeModal.notes && (
                    <div className="commande-notes-box">📝 {commandeModal.notes}</div>
                  )}
                ...
                <div className="modal-footer">
                  ...
                  <button className="btn-payer" onClick={handlePayer} disabled={paying}>
                    {paying ? 'Traitement...' : `💳 Encaisser ${commandeModal.total.toLocaleString()} FC`}
                  </button>
                </div>
              </>
            )}
